...
export class Blocked {
  public async block(req: Request, res: Response): Promise<void> {
    ...
    Blocked.prototype.updateBlockedUser(followerId, req.currentUser!.userId, 'block')
  ...
  public async unblock(req: Request, res: Response): Promise<void> {
    const { followerId } = req.params
    Blocked.prototype.updateBlockedUser(followerId, req.currentUser!.userId, 'unblock')
